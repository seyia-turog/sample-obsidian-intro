...
| Action    | Summary                      | Route | Method | External ID             | Operation ID(s) | Status |
| --------- | ---------------------------- | ----- | ------ | ----------------------- | --------------- | ------ |
| **CR008** | Update CRM Device Assignment |       | POST   | updateDeviceAssigngment | DV007           | 🔄     |
...
| Action    | Summary                                | Route | Method | External ID | Operation ID(s) | Status |
| --------- | -------------------------------------- | ----- | ------ | ----------- | --------------- | ------ |
| **MW008** | Send Device Status Change Notification |       | POST   | EXT-DV002   | DV002           | 🔄     |
| **MW009** | Send Certificate Rotation Notice       |       | POST   | EXT-DV005   | DV005           | 🔄     |
| **MW010** | Send Transfer Request to Recipient     |       | POST   | EXT-DV006   | DV006           | 🔄     |
| **MW011** | Send Transfer Completion Notifications |       | POST   | EXT-DV007   | DV007           | 🔄     |
| **MW012** | Send PIN Change Confirmation           |       | POST   | EXT-DV009   | DV009           | 🔄     |
| **MW013** | Send Reset Token via Secure Channel    |       | POST   | EXT-DV010   | DV010           | 🔄     |
| **MW014** | Send PIN Reset Completion Notice       |       | POST   | EXT-DV011   | DV011           | 🔄     |
...
| Action    | Summary                              | Route | Method | External ID | Operation ID(s) | Status |
| --------- | ------------------------------------ | ----- | ------ | ----------- | --------------- | ------ |
| **PD005** | Generate CSR & Submit to External CA |       | POST   | EXT-DV003   | DV003           | 🔄     |
| **PD006** | Sign Certificate & Issue Device Cert |       | POST   | EXT-DV004   | DV004           | 🔄     |
| **PD007** | Generate NEW CSR & Submit to CA      |       | POST   | EXT-DV005   | DV005           | 🔄     |
...
| Action    | Summary                     | Route | Method | External ID | Operation ID(s) | Status |
| --------- | --------------------------- | ----- | ------ | ----------- | --------------- | ------ |
| **SU005** | Update Device Preferences   |       | POST   | EXT-DV002   | DV002           | 🔄     |
| **SU006** | Set PIN Policy Settings     |       | POST   | EXT-DV008   | DV008           | 🔄     |
| **SU007** | Update PIN Change Timestamp |       | POST   | EXT-DV009   | DV009           | 🔄     |
| **SU008** | Update Security Settings    |       | POST   | EXT-DV011   | DV011           | 🔄     |
