...
| **MW010** | Send Transfer Completion Notifications |       | POST   | EXT-DV007   | DV007           | 🔄     |
| **MW011** | Send PIN Change Confirmation           |       | POST   | EXT-DV009   | DV009           | 🔄     |
| **MW012** | Send Reset Token via Secure Channel    |       | POST   | EXT-DV010   | DV010           | 🔄     |
| **MW013** | Send PIN Reset Completion Notice       |       | POST   | EXT-DV011   | DV011           | 🔄     |
