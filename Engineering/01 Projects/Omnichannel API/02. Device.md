...
- **Device Enrollment** – check status, enroll new devices, manage device certificates  
- **Device Activation/Deactivation** – control device access with security enforcement  
- **Device Ownership Transfer** – securely transfer devices between users  
- **Device PIN Management** – create, change, reset, and confirm device PINs  
- **Certificate Management** – generate, sign, rotate device certificates  
- **Notifications & Updates** – communicate status, changes, and confirmations to users  
...
| **dev_manage** | Activate/Deactivate Devices | DV002 | 🔄 |
| **dev_certs** | Manage Device Certificates | DV003–DV005 | 🔄 |
| **dev_transfer** | Device Ownership | DV006–DV007 | 🔄 |
...
|------|------|------------|--------|
| **DR001** | Administrator | All Device Permissions | 🔄 |
| **DR002** | Security Officer | dev_status, dev_manage, dev_certs | 🔄 |
| **DR003** | Support Officer | dev_transfer, dev_pin | 🔄 |
...
|-----------|--------|-----------|--------|
| **P_DEV_001** | Devices MUST be enrolled before activation | `device.status eq enrolled` | 🔄 |
| **P_DEV_002** | PIN resets require valid reset token | `token.status eq valid` | 🔄 |
