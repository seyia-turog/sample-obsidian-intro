...
| CRB012     | Retrieve Merchant Detail   | /api/v1/stakeholders/third-party-providers/{{thirdPartyProviderId}} | GET        | MCB002           | 🔄         |
| CRB013     | Add Merchant               | /api/v1/stakeholders/third-party-providers                          | POST       | MCB003           | 🔄         |
| CRB015     | Update Merchant Config     | /api/v1/stakeholders/third-party-providers/{{thirdPartyProviderId}} | PUT        | MCB004           | 🔄         |
| CRB016     | Remove Merchant            | }/api/v1/stakeholders/third-party-providers                         | DELETE     | MCB005           | 🔄         |
