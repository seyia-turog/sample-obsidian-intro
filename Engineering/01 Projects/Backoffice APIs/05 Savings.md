...
| CBB049     | List Charges                            |                                                   | GET        | listCharges        |            |
| CBB050     | Get Charge Details                      |                                                   | GET        | getChargeDetails   |            |
| CBB051     | List Account Charges                    |                                                   | GET        | listAccountCharges |            |
| CBB052     | Reverse Charge                          |                                                   | POST       | reverseCharge      |            |
|            |                                         |                                                   |            |                    |            |
...
| **Action** | **Summary**                  | **Route** | **Method** | **Operation ID** | **Status** |
| ---------- | ---------------------------- | --------- | ---------- | ---------------- | ---------- |
| PPB001     | Execute Outbound Transaction |           | POST       | SVB014           | 🔄         |
