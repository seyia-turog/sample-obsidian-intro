...
| LNA013     | List Loan Applications        | /loans/applications                                | GET        | listLoanApplications        | 🔄         |
...
| LNA018     | Write Off Loan Account        |                                                    | POST       | writeOffLoanAccount         | 🔄         |
...
| CBB042     | Fetch Repayment Schedule           | /api/v1/loans/account/schedule/{loanId}                   | GET        | LNB004           | 🔄         |
...
| CBB056     | Write Off Loan Account             |                                                           | POST       | LNA018           | 🔄         |
